...
# Add HelloWorld
git clone https://github.com/jerrykuku/lua-maxminddb package/lua-maxminddb  #git lua-maxminddb 依赖
git clone https://github.com/jerrykuku/luci-app-vssr package/luci-app-vssr  #HelloWorld

# Add 京东签到
git clone https://github.com/jerrykuku/node-request package/node-request  #京东签到依赖
...
#添加第三方argon-主题
#git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon.git package/luci-theme-argon  #添加第三方argon-主题
